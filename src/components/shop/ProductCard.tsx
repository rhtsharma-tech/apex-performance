...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="relative">
      ...
      {/* Cart button — outside Link so it never blocks navigation */}
      <button
        onClick={handleAddToCart}
        className="absolute bottom-[72px] right-3 w-9 h-9 bg-primary rounded-full flex items-center justify-center opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300 hover:scale-110 active:scale-95 z-10"
